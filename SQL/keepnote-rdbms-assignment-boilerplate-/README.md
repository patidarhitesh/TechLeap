...
1. Clone the base boilerplate in the folder **assignment-solution-rdbms** of your local machine
    ...
    `git clone https://gitlab-nht.stackroute.in/stack_dotnet_keep/keepnote-rdbms-assignment-boilerplate.git assignment-solution-rdbms`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-nht.stackroute.in/{{yourusername}}/assignment-solution-rdbms.git`
